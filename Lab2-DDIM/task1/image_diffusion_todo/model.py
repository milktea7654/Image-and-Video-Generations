...
class DiffusionModule(nn.Module):
    ...
    def get_loss_mean(self, x0, class_label=None, noise=None):
        ...
        alpha_bar_t_prev = self.var_scheduler._get_teeth(self.var_scheduler.alphas_cumprod, t_prev)
        beta_t = self.var_scheduler._get_teeth(self.var_scheduler.betas, t)
        mean_true = (alpha_bar_t_prev.sqrt() * beta_t * x0 + alpha_t.sqrt() * (1 - alpha_bar_t_prev) * x_t) / (1 - alpha_bar_t)
